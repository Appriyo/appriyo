            ...
            <div className="bg-base-100 border border-base-300 rounded-box p-8 shadow-sm">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-medium text-base-content mb-1">Initial Review</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-medium text-base-content mb-1">Expert Consultation</h4>
                    <p className="text-base-content/70 text-sm">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-medium text-base-content mb-1">Clear Next Steps</h4>
                    <p className="text-base-content/70 text-sm">
            ...
            <div className="bg-base-100 border border-base-300 rounded-box p-8 shadow-sm">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-base-content/70 ml-8">contact@appriyo.com</p>
                  <p className="text-base-content/50 text-sm ml-8 mt-1">Typically reply within 24 hours</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base-content/70 ml-8">Dhaka, Bangladesh</p>
                  <p className="text-base-content/50 text-sm ml-8 mt-1">Available for remote consultations worldwide</p>
                </div>
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="font-medium text-base-content">Office Hours</span>
                  </div>
                  <p className="text-base-content/70 ml-8">Sunday - Thursday</p>
                  <p className="text-base-content/70 ml-8">9:00 AM - 6:00 PM (GMT+6)</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-base-300 rounded-box bg-base-100 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
                ...
                <div>
                  <label htmlFor="service" className="block text-sm font-medium text-base-content mb-2">
                    Project Type
                  </label>
                  <select
                    id="service"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 border border-base-300 rounded-box bg-base-100 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors resize-none"
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full py-3 px-6 bg-primary text-primary-content font-medium rounded-box hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary/20 transition-colors"
                  >
                    Send Message
                  </button>
