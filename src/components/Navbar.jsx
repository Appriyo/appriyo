      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-base-100 border border-base-300 rounded-lg p-6 lg:p-8 shadow-sm">
            ...
            <div className="bg-base-100 border border-base-300 rounded-lg p-6 lg:p-8 shadow-sm">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-base-content ml-8">contact@appriyo.com</p>
                ...
                <div>
                  ...
                  <p className="text-base-content ml-8">Dhaka, Bangladesh</p>
                ...
                <div>
                  ...
                  <p className="text-base-content ml-8">Sunday - Thursday</p>
                  <p className="text-base-content ml-8">9:00 AM - 6:00 PM (GMT+6)</p>
                </div>
              </div>
          ...
          <div>
            <form onSubmit={handleSubmit} className="bg-base-100 border border-base-300 rounded-lg p-6 lg:p-8 shadow-sm">
              <h3 className="text-xl font-semibold text-base-content mb-6">
                Send Us a Message
              </h3>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-base-100 border border-base-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-base-100 border border-base-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors resize-none"
